...
%% \Qitem = Item with automatic numbering. The first optional argumenthttps://v2.overleaf.com/2521424642hmzzvrdfgxkh
...
\begin{enumerate}[topsep=5pt,leftmargin=2.8em]
...
\definecolor{skincolor}{RGB}{0.99, 0.90,0.90}
