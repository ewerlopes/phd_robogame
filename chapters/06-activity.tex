...
In literature, some approaches for activity recognition are based on the analysis of data coming from camera devices. Others, instead, focus on data coming from wearable devices, such as: cellphones, watches and~\gls{imu} -- a specific-purpose device for measuring accelerations and rotation angles. Across years, the type of analysis carried out has pretty much shifted from basic exploratory analysis,~\eg descriptive statistics, %TODO Still to be fixed ANDY summary? EWERTON: Summary statistics is a well-known concept, see this: https://en.wikipedia.org/wiki/Summary_statistics %ANDY Ok, I didn't know the term, as, I believe, most of computer scientists not working with statistics, If you are sure that actually those models were "summary statistics" and not just "descriptive statistics", you may cite either wikipedia or Upton, G., Cook, I. (2006). Oxford Dictionary of Statistics, OUP. ISBN 978-0-19-954145-4
% EWERTON: Actually it address this by changin summary to descriptive. ANDY Descriptive statistics is a name much more common than summary statistics, and more significant.
...
%Later, we will present some ideas on modeling player activity by features extracted from their spatial relationship with the robot as estimated from laser data. %TODO If this has been actually done, as I expect, it should be described as a section in this chapter. If not, this paragraph should go in the future works.
%EWERTON: But, this was addressed in chapter 7.
