...
From our experience, we have identified at least three dimension to consider when designing a~\gls{pirg}. Each dimension presents its own set of utilities/challengers, some of which are summarized in Figure~\ref{graph:PIRG_design_structure}. 
