...
\begin{figure}[h]
  ...
  \caption{The drone and the Jedi trainee playing JediTrainer 3.0. On the bottom right the image taken by the on board camera, on the bottom left the interpretation of the image in terms of color blobs. The green rectangle on the top of the blue one is the target where the drone is aimed at blast its laser shot~\cite{bonarini_timing_2014}.}
...
%EWERTON:  MORE CAN BE WRITTEN HERE, NO?


%\input{chart/competitive_map.tex}
%\input{chart/engagement_map.tex}
