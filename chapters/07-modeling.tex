...
\begin{figure}[h]
	...
	\caption{Different lines represent the~\gls{mse} obtained for different dictionary sizes and number of topics. The~\gls{mse} is estimated with respect to the similarity expressed in the matrix containing human similarity judgment.}
