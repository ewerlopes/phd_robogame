...
However, this model is limited. %TODO I cannot evaluate it since I cannot understand it. EWERTON: Can you be more precise on this? ANDY IF the "several" are the following ONE, let's arrange the sentence in a better way EWERTON: Okay, redefined the sentence
