...
\input{chart/hardware_map.tex} %TODO Planning is completely missing in the chart as well as in the description. Even if it is basic it deserves a subsection, and a ball here. % EWERTON: It's missing here because planning is not a hardware concern in my view. Note that planning appears in the graph of chapter 4 where it becomes important for playing for competition. Anyway, I have put a circle for it under computing
