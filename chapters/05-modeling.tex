...
\begin{figure}[h]
	...
	\begin{subfigure}[h]{\columnwidth}
		\centering      
		\includegraphics[draft=false, width=\columnwidth]{images/04-activity/combined.png}
		\caption{}
		\label{fig:fun}
	\end{subfigure}
	~
	\begin{subfigure}[h]{\columnwidth}
		\centering      
      	\includegraphics[draft=false,width=\columnwidth]{images/04-activity/combined_less.png}
      	\caption{}
      	\label{fig:nofun}
     \end{subfigure}
