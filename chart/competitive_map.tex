    ...
    \begin{tikzpicture}[ every annotation/.style = {draw,
      ...
      \path[mindmap,concept color=black!40,text=white,
        ...
        child[concept color=orange] { node[concept,font=\fontsize{14pt}{17pt}\selectfont\bfseries] {Safety}
            ...
            child { node[concept, font=\fontsize{8pt}{17pt}\selectfont\bfseries] {collision}}
            child { node[concept, font=\fontsize{8pt}{17pt}\selectfont\bfseries] {structural}}
        };
    \end{tikzpicture}
    \caption{Some relevant concepts for the design of the competitive advantage in our autonomous agent~\gls{pirg}.}
